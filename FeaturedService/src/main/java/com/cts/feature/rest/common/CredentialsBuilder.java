package com.cts.feature.rest.common;
...
/**
 * Class responsible for creating the authentication string based on the
 * credentials held in the Configuration.
 */
@Controller
public class CredentialsBuilder {
	...
	/**
	 * Constructs the credentials string. It gets the required data from the
	 * Configuration module and encodes it as it is described here:
