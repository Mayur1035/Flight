...
import com.cts.feature.rest.interceptor.AuthenticatingGetInterceptor;
import com.cts.feature.rest.interceptor.LoggingRequestInterceptor;

/**
 * Class responsible for executing the GET call.
 * 
 * @param <RQ>
 *            the request domain class.
 */
@Controller
@Scope("prototype")
public class GenericRestGetCall<RQ extends BaseDomainRequest> {
	...
	public <RS> RS doCall(Class<RS> cls, SharedContext context) {
		...
		try {
			...
			response = restTemplate.getForObject(requestString, cls, new Object[] {});
